...
With TestMu AI (Formerly LambdaTest), this JavaScript smart test selection module enables the Test At Scale (TAS) platform to identify and run only the tests impacted by a code change, dramatically shortening feedback loops.
...
```bash
git clone https://github.com/LambdaTest/test-at-scale-js-smart-select.git
cd test-at-scale-js-smart-select
npm install
```
